...
import s from "./SignUpCardSeparated.module.css";

/* ══════════════════════════════════════════════
   Types
   ══════════════════════════════════════════════ */

export interface SignUpCardSeparatedProps {
...
/* ══════════════════════════════════════════════
   SignUpCardSeparated Component
   ══════════════════════════════════════════════ */

export function SignUpCardSeparated({
    logoText = "O",
    logo,
        ...
        <div className={cn(s.wrapper, className)}>
            <div>
                <div className={s.card}>
                    ...
                    {/* Bottom — Form */}
                    <form className={s.bottomSection} onSubmit={handleSubmit}>
