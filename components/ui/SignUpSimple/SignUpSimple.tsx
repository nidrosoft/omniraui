...
import s from "./SignUpSimple.module.css";

/* ══════════════════════════════════════════════
   Types
   ══════════════════════════════════════════════ */

export interface SignUpSimpleProps {
    /** Product/brand name */
    productName?: string;
        ...
        <div className={cn(s.wrapper, className)}>
            <div className={s.card}>
                ...
                <div className={s.footer}>
                    ...
                    <button type="button" className={s.footerLink} onClick={onSignInClick}>
                        Sign in
                    </button>
                </div>
