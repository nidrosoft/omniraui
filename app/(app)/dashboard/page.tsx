...
import { Folder, DollarCircle, Clock, TrendUp, Flash, FolderAdd, UserAdd, DocumentText, Chart21, Calendar2, InfoCircle, TickCircle } from "iconsax-react";
    ...
    return (
        <div className={s.page}>
            ...
            <section className={s.twoColGrid}>
                ...
                {/* Right: Pending Approvals & Team Activity Stack */}
